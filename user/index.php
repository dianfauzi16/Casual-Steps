  ...
  <section class="hero-section">
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-md-6">
          <img src="../admin/Assets/hoka.jpg" alt="Contoh Sepatu" class="img-fluid" />
        </div>
      </div>
    </div>
  </section>
  ...
  <div id="heroCarousel" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="../admin/Assets/1.png" class="d-block w-100 carousel-img" alt="Gamvar Carousel">
      ...
      <div class="carousel-item">
        <img src="../admin/Assets/2.png" class="d-block w-100 carousel-img" alt="Gamvar Carousel">
        <div class="carousel-caption">
      ...
      <div class="carousel-item">
        <img src="../admin/Assets/3.png" class="d-block w-100 carousel-img" alt="Gamvar Carousel">
        <div class="carousel-caption">
        ...
        <div class="col-md-6">
          <div class="row">
            <div class="col-11 mx-auto mb-1">
              <img src="../admin/Assets/cs-removebg-preview.png" alt="Contoh Sepatu Fitur" class="img-fluid rounded" />
            </div>
          </div>
        </div>
    ...
    <div class="container">
      <div class="row align-items-center">
        ...
        <div class="col-md-6 mt-4 mt-md-0">
          <img src="../admin/Assets/brand-logo.png" alt="Tentang <?php echo htmlspecialchars($nama_toko); ?>" class="img-fluid" />
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="row">
        ...
        <div class="col-md-4 mb-4 mb-md-0">
          ...
          <ul class="list-unstyled mt-3 d-flex">
            <li class="me-3">
              <a href="https://instagram.com/username" class="text-white text-decoration-none fs-4">
                <i class="fab fa-instagram"></i>
              </a>
            </li>
            <li class="me-3">
              <a href="https://tiktok.com/@username" class="text-white text-decoration-none fs-4">
                <i class="fab fa-tiktok"></i>
              </a>
            </li>
            <li class="me-3">
              <a href="https://facebook.com/username" class="text-white text-decoration-none fs-4">
                <i class="fab fa-facebook"></i>
              </a>
            </li>
            <li class="me-3">
              <a href="https://youtube.com/c/channelname" class="text-white text-decoration-none fs-4">
