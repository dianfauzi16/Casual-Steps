...
if (isset($_GET['id']) && filter_var($_GET['id'], FILTER_VALIDATE_INT)) {
    ...
    if ($stmt = $conn->prepare($sql_product_detail)) {
        ...
        if ($result->num_rows == 1) {
            ...
            $product_reviews = [];
            $sql_reviews = "SELECT pr.rating, pr.review_text, pr.created_at, u.name 
...
<body class="d-flex flex-column min-vh-100">
    ...
    <main class="container py-5" style="margin-top: 80px;">
        ...
        <?php elseif ($product_detail): ?>
            ...
            <!-- Daftar Ulasan yang Ditampilkan -->
            <div class="row mt-4">
                <div class="col-12">
                            ...
                            <?php foreach ($product_reviews as $review): ?>
                                <div class="list-group-item">
                                    <div class="d-flex w-100 justify-content-between">
                                        <h5 class="mb-1 fw-bold"><?php echo htmlspecialchars($review['name']); ?></h5>
