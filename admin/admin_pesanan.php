                            ...
                            <tbody>
                                <?php if (!empty($daftar_pesanan)): ?>
                                    <?php foreach ($daftar_pesanan as $pesanan): ?>
                                        <tr>
                                            <td>#<?php echo htmlspecialchars($pesanan['id']); // Menggunakan 'id' sesuai tabel orders Anda 
                                                    ?></td>
                                            ...
                                            <td>Rp <?php echo number_format($pesanan['total_price'], 0, ',', '.'); // Menggunakan 'total_price' 
                                                    ?></td>
                                            <td>
                                                <?php
