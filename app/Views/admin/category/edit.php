    ...
    <div class="col-md-6">
        <div class="card border-0 shadow-sm rounded-4 mb-4">
            ...
            <div class="card-body p-4">
                ...
                <form action="<?= BASE_URL ?>index.php?url=AdminCategory/update" method="POST">
                    <input type="hidden" name="id" value="<?= htmlspecialchars($category['id_kategori']) ?>">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control bg-light border-0" id="nama_kategori" name="nama_kategori" value="<?= htmlspecialchars($category['nama_kategori']) ?>" required autofocus>
                        </div>
                    </div>
